      ...
      <div className="bg-white py-5">
        <div className="relative mx-auto hongkongpicture">
          ...
          <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 py-24 text-center sm:py-64 lg:px-0">
            ...
            <a href="registration" className="mt-8 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100 capitalTitle"  target="_blank">Select All Tours</a>
          </div>
        </div>
      </div>
    );
