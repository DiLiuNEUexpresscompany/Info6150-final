                ...
                <div>
                  <form action="#" method="POST" className="space-y-6">
                    ...
                    <div>
                      <button
                        type="submit"
                        className="title flex w-full justify-center rounded-md hoverblue px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:hoverblue focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                      >
                        Sign in
                      </button>
                    </div>
