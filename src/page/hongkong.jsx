    ...
    const hongkongSeasonsData = [
        {
          name: "SPRING",
          svg: (
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="qi-101-fill h-24 w-auto" viewBox="0 0 16 16">
        ...
        },
        {
            name: "SUMMER",
            svg: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="qi-100 h-24 w-auto" viewBox="0 0 16 16">
          ...
          },
          {
            name: "AUTUMN",
            svg: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="qi-509 h-24 w-auto" viewBox="0 0 16 16">
          ...
          },
          {
            name: "WINTER",
            svg: (
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="qi-400-fill h-24 w-auto" viewBox="0 0 16 16">
